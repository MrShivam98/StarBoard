...
export default function Uploader() {
    ...
    return (
        <div className="flex items-center justify-center w-full p-6 my-10">
            <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">JSON {"[{ propertyName, tenent, rent, lease, size, financing, address }]"}</p>
                </div>
                <input onChange={handleUploader} id="dropzone-file" type="file" accept=".json" className="hidden" />
            </label>
        </div>
    )
}
